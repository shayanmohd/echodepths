...
android {
    namespace = "com.mohdshayan.echodepths"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.mohdshayan.echodepths"
        minSdk = 26
        targetSdk = 36
        versionCode = 1
        versionName = "0.1.0"
...
// The HTML5 core lives in ../../game and is copied into assets on every build.
val syncGameAssets = tasks.register<Copy>("syncGameAssets") {
    from(rootProject.file("../game")) { exclude("**/.DS_Store") }
